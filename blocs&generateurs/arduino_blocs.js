...
Blockly.Blocks["serial_write_new"]={init:function(){
        this.setColour("#5BA599");
         this.setHelpUrl(Blockly.Msg.HELPURL_034);
        this.appendValueInput("CONTENT", String).appendField(Blockly.Msg.Serial_Write);
        this.setPreviousStatement(true, null);
...
Blockly.Blocks["digital_write_highlow"] = {
  init: function () {
    this.setColour("#A5675B");
    this.setHelpUrl(Blockly.Msg.HELPURL_032);
    this.appendValueInput("PIN")
      .setCheck("Number")
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("Digital Write (HIGH/LOW) to pin");
    this.appendDummyInput()
      .setAlign(Blockly.ALIGN_RIGHT)
      .appendField("State")
    ...
    this.setNextStatement(true, null);
    this.setInputsInline(true);
    this.setTooltip("Writes HIGH or LOW to the specified digital pin.");
  }
};
...
Blockly.Blocks["stepservo_continuos_move"] = {
  init: function () {
    ...
    this.appendDummyInput()
      .appendField("Delay (Speed)");

    this.appendValueInput("PIN_GR")
      .setCheck("Number");
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("Moves a servo to a position gradually by controlling delay.");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks["stepservo_continuos_move_esp32"] = {
  init: function () {
    this.setColour(80);
    this.setInputsInline(true);
...
//esp32
 ...
 Blockly.Blocks["stepservo_continuos_move_ru_esp32"] = {
   init: function() {
    this.setColour(80);
  this.setInputsInline(true);
    this.appendDummyInput()
...
Blockly.Blocks["ultrasonic_ranger_sensor"] = {
  init: function() {
    ...
    // 🔄 Change from output to statement block
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks["ultrasonic_ranger_sensor_side"] = {
  init: function() {
    this.setColour("#6D7497");
    this.setHelpUrl(Blockly.Msg.HELPURL_059);
    ...
    this.appendValueInput("PIN_TRIG")
      .setCheck('Number')
      .setAlign(Blockly.ALIGN_RIGHT);
    ...
    this.appendValueInput("PIN_ECHO")
      .setCheck('Number')
      .setAlign(Blockly.ALIGN_RIGHT);

    // 🔄 Change from statement to output value block
    this.setOutput(true, 'Number');  // You can set the output type as needed
...
Blockly.Blocks["base_form_RR_right"] = {
  init: function() {
    this.setColour("#308189");
    ...
    this.setInputsInline(true);
    this.setOutput(true, 'Number');  // Allow block to be used as value
    this.setTooltip("Returns the value incremented or decremented by 1");
  }
};
...
Blockly.Blocks['web_esp_conect'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Web - Wifi > Name")
      .appendField(new Blockly.FieldTextInput("ESP32-AP"), "name")
      .appendField("Pass")
...
Blockly.Blocks['web_esp_conect_12f'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Web - Wifi > Name")
...
// TEST CASE
Blockly.Blocks['web_led_toggle'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("LED Toggle on Pin")
...
Blockly.Blocks['web_led_control_stateful'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("LED Toggle Control (ON/OFF)")
      .appendField("GPIO")
      .appendField(new Blockly.FieldNumber(2, 0, 33), "PIN");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(220);
  }
...
Blockly.Blocks['web_raindrop_sensor_status'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Rain Sensor (analog) on PIN")
        .appendField(new Blockly.FieldTextInput("A0"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays rain status via analog input as Raining or Clear");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_gas_sensor_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Gas Sensor (analog) on PIN")
        .appendField(new Blockly.FieldTextInput("A0"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads gas sensor value and displays air quality status");
    this.setHelpUrl("");
  }
};


Blockly.Blocks['web_ultrasonic_distance_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Ultrasonic Distance Monitor TRIG")
        .appendField(new Blockly.FieldTextInput("5"), "TRIG")
        .appendField("ECHO")
        .appendField(new Blockly.FieldTextInput("18"), "ECHO");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays distance read from ultrasonic sensor using TRIG and ECHO pins");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_dht11_dashboard'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("DHT11 on PIN")
        .appendField(new Blockly.FieldTextInput("15"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads temperature and humidity from DHT11 and displays on webpage");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_ldr_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("LDR Light Monitor on PIN")
        .appendField(new Blockly.FieldTextInput("A0"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays light intensity using analog LDR sensor");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_servo_angle_control'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Servo Motor (Web Control) on PIN")
        .appendField(new Blockly.FieldTextInput("18"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Control Servo angle remotely using ESP32 Web Dashboard");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_lcd_text_display'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web LCD I2C Text Display");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays text from a web form on the LCD via I2C.");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_buzzer_control'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Buzzer Control (tone) on PIN")
        .appendField(new Blockly.FieldTextInput("5"), "PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Control a buzzer via web: ON/OFF buttons with 1000 Hz tone.");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_ultrasonic_lcd_monitor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Ultrasonic LCD Monitor");
    this.appendDummyInput()
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays ultrasonic sensor distance on LCD and Webpage");
    this.setHelpUrl("");
  }
};


Blockly.Blocks['web_gas_sensor_buzzer_alarm'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Gas Sensor + Buzzer Alarm (IoT)");
    this.appendDummyInput()
        .appendField("Gas Sensor Pin")
        .appendField(new Blockly.FieldDropdown([
          ["36 (VP)", "36"],
          ["39 (VN)", "39"],
          ["34", "34"],
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Monitors gas level and triggers buzzer alarm if threshold exceeded");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_dht11_lcd_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("DHT11 + LCD Monitor")
        .appendField("DHT Pin")
        .appendField(new Blockly.FieldDropdown([
          ["GPIO 0", "0"],
          ["GPIO 2", "2"],
    ...
    this.setColour(220);
    this.setTooltip("Reads temperature and humidity from DHT11 and displays it on LCD + Web UI");
    this.setHelpUrl("");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['web_ldr_led_smartlight'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("LDR Smart Light")
      .appendField("LDR Pin")
      .appendField(new Blockly.FieldTextInput("36"), "LDR_PIN")
      .appendField("LED Pin")
      .appendField(new Blockly.FieldTextInput("2"), "LED_PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Monitors LDR and controls LED based on threshold");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_servo_lcd_control'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Servo + LCD Control")
      .appendField("Servo Pin")
      .appendField(new Blockly.FieldNumber(14, 0, 33), "SERVO_PIN");
    this.appendDummyInput()
      .appendField("Angle")
      .appendField(new Blockly.FieldAngle(90), "ANGLE");
    
    this.setPreviousStatement(true, null); // ✅ Allow block stacking
    this.setNextStatement(true, null);     // ✅ Allow chaining with others
    this.setColour(220);
    this.setTooltip("Displays angle on LCD and moves servo");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_buzzer_dht11_alert'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Buzzer & DHT11 Alert System");
    this.appendDummyInput()
        .appendField("DHT11 Data Pin")
        .appendField(new Blockly.FieldTextInput("14"), "DHT_PIN");
    this.appendDummyInput()
        .appendField("Buzzer Pin")
        .appendField(new Blockly.FieldTextInput("13"), "BUZZER_PIN");
    this.appendDummyInput()
        .appendField("Alert Threshold °C")
        .appendField(new Blockly.FieldNumber(30, 0, 100), "THRESHOLD");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Triggers buzzer if temperature exceeds threshold");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_rain_lcd_monitor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Rain Sensor LCD Monitor");
    this.appendDummyInput()
      .appendField("Rain Sensor Pin")
      .appendField(new Blockly.FieldDropdown([
        ["A0", "36"],
        ["A1", "39"],
        ["A2", "34"],
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Display rain status using Raindrop Sensor + LCD");
    this.setHelpUrl("");
  }
};


Blockly.Blocks['web_ultrasonic_led_proximity'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Ultrasonic Proximity with LED");
    this.appendDummyInput()
        .appendField("Trigger Pin")
        .appendField(new Blockly.FieldDropdown([
          ["2", "2"], ["4", "4"], ["5", "5"], ["12", "12"], ["14", "14"]
        ]), "TRIG");
    this.appendDummyInput()
        .appendField("Echo Pin")
        .appendField(new Blockly.FieldDropdown([
          ["15", "15"], ["13", "13"], ["18", "18"], ["19", "19"]
        ]), "ECHO");
    this.appendDummyInput()
        .appendField("Red LED Pin")
        .appendField(new Blockly.FieldDropdown([
          ["21", "21"], ["22", "22"], ["25", "25"]
        ]), "RED");
    this.appendDummyInput()
        .appendField("Green LED Pin")
        .appendField(new Blockly.FieldDropdown([
          ["26", "26"], ["27", "27"], ["32", "32"]
        ]), "GREEN");
    this.setColour(220);
    this.setTooltip("Measures distance with ultrasonic sensor and controls LED");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
};

Blockly.Blocks['web_gas_lcd_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Gas Sensor + LCD IoT Monitor")
        .appendField("Gas Sensor Pin")
        .appendField(new Blockly.FieldDropdown([
          ["36 (VP)", "36"],
          ["39 (VN)", "39"],
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads gas value and shows air quality on LCD and webpage.");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_ldr_buzzer_alert'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("LDR Buzzer Light Alert");
    this.appendDummyInput()
      .appendField("LDR Pin")
      .appendField(new Blockly.FieldDropdown([
        ["36", "36"],
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Detects light level and triggers buzzer + web alert");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_dht11_rain_lcd_weather'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("DHT11 + Rain + LCD Weather Station");
    this.appendDummyInput()
        .appendField("DHT11 PIN")
        .appendField(new Blockly.FieldTextInput("4"), "DHT_PIN");
    this.appendDummyInput()
        .appendField("Rain Sensor PIN")
        .appendField(new Blockly.FieldTextInput("36"), "RAIN_PIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads DHT11 and Rain Sensor values, shows on LCD and Web");
    this.setHelpUrl("");
  }
};

Blockly.Blocks['web_ultrasonic_intruder_alert'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Ultrasonic Intruder Alert");
    this.appendDummyInput()
        .appendField("Trig Pin")
        .appendField(new Blockly.FieldDropdown([["13", "13"], ["12", "12"], ["14", "14"], ["27", "27"], ["32", "32"]]), "TRIG_PIN")
        .appendField("Echo Pin")
        .appendField(new Blockly.FieldDropdown([["12", "12"], ["14", "14"], ["33", "33"], ["34", "34"], ["35", "35"]]), "ECHO_PIN");
    this.appendDummyInput()
        .appendField("Buzzer Pin")
        .appendField(new Blockly.FieldDropdown([["26", "26"], ["25", "25"], ["33", "33"], ["2", "2"]]), "BUZZER_PIN")
        .appendField("LED Pin")
        .appendField(new Blockly.FieldDropdown([["25", "25"], ["4", "4"], ["2", "2"]]), "LED_PIN");
    this.setColour(220);
    this.setTooltip("Detects intruders via ultrasonic sensor and triggers alert");
    this.setHelpUrl("");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['web_esp_conect_lcd'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Web - LCD")
      .appendField("Default Text")
      .appendField(new Blockly.FieldTextInput("Hello World"), "defaultText");

    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays an LCD control page with user-input text");
  }
};

Blockly.Blocks['iot_led_ap_server'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web Server LED Control (AP Mode)")
        .appendField("LED GPIO")
        .appendField(new Blockly.FieldNumber(2, 0, 33), "ledPin");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Creates an access point web server to control an LED");
  }
};

Blockly.Blocks['iot_rain_sensor_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("IoT Rain Sensor Monitor (Station Mode)")
        .appendField("Sensor Pin")
        .appendField(new Blockly.FieldNumber(34, 0, 39), "sensorPin");
    this.appendDummyInput()
        .appendField("WiFi SSID")
        .appendField(new Blockly.FieldTextInput("MyWiFi"), "ssid");
    this.appendDummyInput()
        .appendField("Password")
        .appendField(new Blockly.FieldTextInput("password123"), "pass");

    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Connects to WiFi and shows rain status on a webpage.");
  }
};

Blockly.Blocks['iot_ultrasonic_ap_monitor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Ultrasonic Distance Monitor (AP Mode)");
    ...
    this.appendDummyInput()
      .appendField("AP SSID")
      .appendField(new Blockly.FieldTextInput("ESP32_AP"), "SSID");
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Serves a web page in AP mode to show ultrasonic sensor readings.");
  }
};

Blockly.Blocks['iot_gas_sensor_station'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Gas Sensor Monitor (Station Mode)");

    this.appendDummyInput()
      .appendField("Gas Sensor Pin (Analog)")
      .appendField(new Blockly.FieldNumber(34, 0, 39), "GAS");
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Connects to WiFi and displays gas sensor data over a web page.");
  }
};

Blockly.Blocks['iot_dht11_dashboard_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("DHT11 Dashboard (Station Mode)");

    this.appendDummyInput()
        .appendField("DHT Pin")
        .appendField(new Blockly.FieldNumber(15, 0, 39), "DHT_PIN");
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Display DHT11 temperature and humidity via web server in station mode.");
  }
};

Blockly.Blocks['iot_ldr_monitor_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("LDR Monitor (AP Mode)");

    this.appendDummyInput()
        .appendField("LDR Pin (ADC)")
        .appendField(new Blockly.FieldNumber(36, 0, 39), "LDR_PIN");

    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays LDR light intensity value over ESP32 AP web server.");
  }
};

Blockly.Blocks['iot_servo_angle_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Servo Control (AP Mode)");

    this.appendDummyInput()
        .appendField("Servo Pin")
        .appendField(new Blockly.FieldNumber(5, 0, 33), "SERVO_PIN");

    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Servo angle control using web form in AP mode");
  }
};

Blockly.Blocks['iot_lcd_text_display_sta'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Web LCD Text Display (STA Mode)");
    ...
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("LCD text update from browser using WiFi Station Mode");
  }
};

Blockly.Blocks['iot_buzzer_trigger_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Buzzer Trigger (AP Mode)");
    this.appendDummyInput()
        .appendField("Buzzer Pin")
        .appendField(new Blockly.FieldNumber(5, 0, 40), "BUZZER_PIN");  // Default pin 5
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Web buzzer controller using ESP32 in Access Point mode");
  }
};

Blockly.Blocks['iot_ultrasonic_lcd_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Ultrasonic LCD Monitor (AP Mode)");
    this.appendDummyInput()
        .appendField("Trig Pin")
        .appendField(new Blockly.FieldNumber(12, 0, 40), "TRIG");
    this.appendDummyInput()
        .appendField("Echo Pin")
        .appendField(new Blockly.FieldNumber(13, 0, 40), "ECHO");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Shows ultrasonic sensor data on LCD and web (AP mode)");
  }
};

Blockly.Blocks['iot_gas_buzzer_alarm_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Gas Sensor Buzzer Alarm (Station)");
    this.appendDummyInput()
        .appendField("Sensor Pin")
        .appendField(new Blockly.FieldNumber(34, 0, 39), "SENSOR");
    this.appendDummyInput()
        .appendField("Buzzer Pin")
        .appendField(new Blockly.FieldNumber(25, 0, 39), "BUZZER");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Station mode: shows gas level, triggers buzzer & web update");
  }
};

Blockly.Blocks['iot_dht11_lcd_env_monitor_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - DHT11 + LCD Environmental Monitor (Station)");
    this.appendDummyInput()
        .appendField("DHT11 Pin")
        .appendField(new Blockly.FieldNumber(14, 0, 39), "DHTPIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Station mode - DHT11 + LCD environmental status dashboard");
  }
};

Blockly.Blocks['iot_ldr_led_smartlight_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - LDR & LED Smart Light (AP Mode)");
    this.appendDummyInput()
        .appendField("LDR Pin")
        .appendField(new Blockly.FieldNumber(34, 0, 39), "LDRPIN");
    this.appendDummyInput()
        .appendField("LED Pin")
        .appendField(new Blockly.FieldNumber(2, 0, 39), "LEDPIN");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("LDR + LED smart light system with threshold setting over web in AP mode");
  }
};

Blockly.Blocks['iot_servo_lcd_ap_welcome'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - LCD + Servo Welcome Page (AP Mode)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Starts AP-mode WebServer with a simple welcome page. Can be extended with LCD or servo code.");
  }
};

Blockly.Blocks['iot_temp_buzzer_alert_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - DHT11 Temp Alert with Buzzer (Station Mode)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads DHT11 sensor, shows alert if temp > threshold using a buzzer, and displays status in web page");
  }
};

Blockly.Blocks['iot_rain_lcd_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Raindrop Sensor Weather Display (Station Mode)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads raindrop sensor, displays status on LCD and styled web page.");
  }
};

Blockly.Blocks['iot_ultrasonic_led_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Ultrasonic LED Proximity System (AP Mode)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Reads ultrasonic sensor, updates LEDs and web UI based on distance.");
  }
};

Blockly.Blocks['iot_weatherstation_dht_raindrop_gas_lcd'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Weather Station (DHT11 + Raindrop + Gas + LCD) [STA]");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("IoT Weather Station with DHT11, Gas Sensor, Raindrop Sensor & LCD (WiFi Station)");
  }
};

Blockly.Blocks['iot_security_ultrasonic_buzzer_led_ap'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - IoT Security (Ultrasonic + Buzzer + LED) [AP Mode]");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("ESP32 Security System: Detect intrusion using ultrasonic sensor, sound buzzer & show status via web.");
  }
};

Blockly.Blocks['iot_gas_temp_lcd_buzzer_station'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Gas & Temperature Monitor (LCD + Buzzer) [Station Mode]");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("ESP32 Gas, Temperature & Humidity Monitor with LCD display, buzzer alert and HTML dashboard (Station Mode).");
  }
};

Blockly.Blocks['iot_smart_light_ldr_led_servo'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Smart Lighting (LDR + LED + Servo)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("IoT Smart Lighting: Web control of servo + LDR + LED brightness via ESP32");
  }
};

Blockly.Blocks['iot_rain_servo_led_lcd'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Rain-Activated System (Servo + LED + LCD)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays rain status via web, moves servo, controls LED, and LCD text.");
  }
};

Blockly.Blocks['iot_proximity_ultrasonic_buzzer_lcd'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Proximity Alert (Ultrasonic + Buzzer + LCD)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays proximity distance via web, alerts via buzzer & LCD.");
  }
};

Blockly.Blocks['iot_gas_safety_system'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Gas Safety (Buzzer + LED + LCD)");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("IoT gas monitoring and alert system with display and warning.");
  }
};

Blockly.Blocks['iot_servo_ldr_lcd_display'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Servo + LDR + LCD Display");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Display LDR reading and servo angle on web and LCD.");
  }
};

Blockly.Blocks['iot_tank_ultrasonic_servo'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Tank Level with Ultrasonic & Servo");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays tank level (ultrasonic) and adjusts valve angle (servo).");
  }
};

Blockly.Blocks['iot_fire_gas_monitor'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Fire & Gas Monitor UI");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays fire and gas safety status with sensor values.");
  }
};

Blockly.Blocks['iot_smart_blinds_dashboard'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Smart Blinds Dashboard");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Display live LDR and Servo values for Smart Blinds.");
  }
};

Blockly.Blocks['iot_greenhouse_dashboard'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Smart Greenhouse Dashboard");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays live greenhouse data including temp, humidity, gas, rain, light, distance, servo, LED, buzzer.");
  }
};

Blockly.Blocks['iot_home_multi_sensor_dashboard'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Multi-Sensor Home Dashboard");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Displays IoT dashboard with temperature, humidity, rain, gas, LDR, distance, servo, LED and buzzer values.");
  }
};

Blockly.Blocks['iot_home_automation_hub'] = {
  init: function () {
    this.appendDummyInput()
        .appendField("Web - Home Automation Hub");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(220);
    this.setTooltip("Comprehensive smart home dashboard with all sensor readings and actuator statuses.");
  }
};
...
Blockly.Blocks["math_operator_dropdown"] = {
  init: function () {
    this.setColour(Blockly.Blocks.math.HUE); // match math block color
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([
        ["+", "+"],
        ["−", "-"],
...
// current custom blocks for VBC 2025 
...
Blockly.Blocks['math_isnan'] = {
    init: function () {
        this.appendValueInput("VALUE")
            ...
            .appendField("isnan");
        this.setOutput(true, "Boolean");
        this.setColour(230); // Math-style blue
        this.setTooltip("Check if the value is NaN (not a number).");
        this.setHelpUrl("https://www.cplusplus.com/reference/cmath/isnan/");
    }
};

Blockly.Blocks['logic_return'] = {
  init: function () {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(false, null);
    this.setColour(230); // Purple: Logic category or adjust as needed
    this.setTooltip("Return from the current function with or without a value");
    this.setHelpUrl("");
  }
};
